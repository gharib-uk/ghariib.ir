...
tags:
  - smartdns, proxy, sniproxy
summary: "Create a SNIProxy with SmartDNS"
---

# SmartDNS

This method is usefule when a service is prohibited in your region/area.
Buy a vps a 4$ worth VPS is good enough and it is preferable to use Ubuntu/Debian Images.
...
```
- Download src or prebuilt binaries or packages from [smartdns](https://github.com/pymumu/smartdns)
...
# example:
#   proxy-server socks5://alireza:MainHelpAptel45610@127.0.0.1:2059 -name proxy
